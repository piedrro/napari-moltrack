...
class Ui_Frame(object):
    ...
    def retranslateUi(self, Frame):
        ...
        self.picasso_detect_mode.setItemText(0, _translate("Frame", "Picasso"))
        self.picasso_detect_mode.setItemText(1, _translate("Frame", "StormTracker"))
